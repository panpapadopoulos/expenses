/**
 * Expenses - Cloudflare Worker
 * Handles authentication and data storage via KV.
 * Mirrors the SubTrack worker: password/cookie gate in front of a static
 * site proxied from GitHub Pages, plus a same-origin /api/data endpoint
 * backed by a Cloudflare KV namespace.
 */

const COOKIE_NAME = 'expenses_auth';
const COOKIE_MAX_AGE = 60 * 60 * 24 * 30; // 30 days
const GITHUB_ORIGIN = 'https://panpapadopoulos.github.io';
const GITHUB_PATH = '/expenses';
    ...
    if (url.pathname === '/api/data') {
        ...
        if (request.method === 'POST') {
            try {
                ...
                await env.EXPENSES_DATA.put('user_data', JSON.stringify(data));
...
async function proxyToGitHub(request, url) {
    ...
    try {
        ...
        newHeaders.set('X-Proxied-By', 'Expenses-Proxy');
...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Crect width='64' height='64' rx='16' fill='%230f172a'/%3E%3Ccircle cx='32' cy='32' r='19' fill='none' stroke='%23f8fafc' stroke-width='4'/%3E%3Cpath d='M32 22v20M26 27a6 6 0 0 1 6-4c4 0 6 2.2 6 4.8 0 6-12 4-12 10 0 2.6 2 4.8 6 4.8a6 6 0 0 0 6-4' stroke='%2310b981' stroke-width='4' stroke-linecap='round' fill='none'/%3E%3C/svg%3E" />
        ...
        <div class="logo">
            <div style="width:44px; height:44px; background:#0f172a; border-radius:14px; display:flex; align-items:center; justify-content:center; box-shadow:0 10px 15px -3px rgba(0,0,0,0.1);">
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none">
                    <circle cx="12" cy="12" r="9" stroke="#f8fafc" stroke-width="2"/>
                    <path d="M12 7v10M9.5 9.4a2.5 2.5 0 0 1 2.5-1.8c1.8 0 2.6 1 2.6 2 0 2.4-5.1 1.6-5.1 4 0 1 .9 2 2.5 2a2.5 2.5 0 0 0 2.5-1.7" stroke="#10b981" stroke-width="2" stroke-linecap="round" fill="none"/>
                </svg>
            </div>
            Expenses
        </div>
